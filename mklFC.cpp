...
int mklFullyConnected(std::string input, std::string weight, std::string bias, std::string output){
...
int main(int argc, char *argv[])
{
     try
    {
        ...
        else if (std::string(argv[1]) == "mkl" && std::string(argv[2]) == "fullyconnected")
        {
            if (argc != 7)
            {
            ...
            mklFullyConnected(argv[3], argv[4], argv[5], argv[6]);
